...
test('staging editor keeps the dependency bootstrap synchronous and loads feature scripts in order without serial downloads', () => {
...
test('staging editor fetches the selected card concurrently with account and entitlement lookups', () => {
