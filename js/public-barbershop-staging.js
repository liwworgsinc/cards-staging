...
(function(){
  ...
  const TYPES={
    barber:{label:'Barber',booking:'Book Barber Appointment',services:'Cuts · grooming · style',social:'Follow My Work',dock:'Services',room:'Barber Services',gallery:'Barber Portfolio',specialty:'Cuts · fades · grooming',promo:'Fresh work. Clean details. Professional service.',bio:'Explore services, recent work and availability, then book your appointment.'},
    hair:{label:'Hair Stylist',booking:'Book Hair Appointment',services:'Cuts · color · styling',social:'See My Styles',dock:'Services',room:'Hair Services',gallery:'Hair Portfolio',specialty:'Cuts · color · styling',promo:'Hair services tailored to your style.',bio:'Explore services, styles and availability, then book your appointment.'},
    braider:{label:'Braider',booking:'Book Braiding Appointment',services:'Braids · protective styles',social:'See My Work',dock:'Services',room:'Braiding Services',gallery:'Braiding Portfolio',specialty:'Braids · protective styles',promo:'Protective styles with clean, detailed finishing.',bio:'Explore braiding services, recent work and availability.'},
    loctician:{label:'Loctician',booking:'Book Loc Appointment',services:'Locs · retwists · maintenance',social:'See My Work',dock:'Services',room:'Loc Services',gallery:'Loc Portfolio',specialty:'Locs · retwists · maintenance',promo:'Loc care, styling and maintenance.',bio:'Explore loc services, work and availability.'},
    wig:{label:'Wig / Install Specialist',booking:'Book Install Appointment',services:'Wigs · installs · extensions',social:'See My Work',dock:'Services',room:'Install Services',gallery:'Install Portfolio',specialty:'Wigs · installs · extensions',promo:'Install and styling services made for your look.',bio:'Explore installs, services and availability.'},
    nails:{label:'Nail Tech',booking:'Book Nail Appointment',services:'Sets · fills · nail art',social:'See My Nail Work',dock:'Services',room:'Nail Services',gallery:'Nail Portfolio',specialty:'Sets · fills · nail art',promo:'Detailed sets, art and clean finishes.',bio:'Explore nail services, work and availability.'},
    lashes:{label:'Lash Artist',booking:'Book Lash Appointment',services:'Lashes · fills · extensions',social:'See My Work',dock:'Services',room:'Lash Services',gallery:'Lash Portfolio',specialty:'Lashes · fills · extensions',promo:'Lash services tailored to your look.',bio:'Explore lash services, results and availability.'},
    brows:{label:'Brow Artist',booking:'Book Brow Appointment',services:'Brows · tint · shaping',social:'See My Work',dock:'Services',room:'Brow Services',gallery:'Brow Portfolio',specialty:'Brows · tint · shaping',promo:'Brow services shaped around your features.',bio:'Explore brow services, results and availability.'},
    makeup:{label:'Makeup Artist',booking:'Book Makeup Session',services:'Beauty · bridal · events',social:'See My Looks',dock:'Services',room:'Makeup Services',gallery:'Makeup Portfolio',specialty:'Beauty · bridal · events',promo:'Camera-ready looks for beauty, bridal and events.',bio:'Explore looks, services and availability.'},
    esthetician:{label:'Esthetician',booking:'Book Skin Treatment',services:'Facials · skincare · treatments',social:'See My Work',dock:'Services',room:'Skin Services',gallery:'Skin Results',specialty:'Facials · skincare · treatments',promo:'Personalized skincare focused on healthy-looking results.',bio:'Explore treatments, results and availability.'},
    wax:{label:'Wax Specialist',booking:'Book Wax Appointment',services:'Waxing · body care',social:'See My Work',dock:'Services',room:'Wax Services',gallery:'Results',specialty:'Waxing · body care',promo:'Professional waxing and body-care services.',bio:'Explore services and availability.'},
    massage:{label:'Massage Therapist',booking:'Book Massage',services:'Massage · bodywork',social:'Explore My Work',dock:'Services',room:'Massage Services',gallery:'Studio Gallery',specialty:'Massage · bodywork',promo:'Bodywork focused on comfort, recovery and relaxation.',bio:'Explore massage services and availability.'},
    spa:{label:'Spa / Wellness',booking:'Book Spa Service',services:'Facials · wellness · relaxation',social:'Explore My Studio',dock:'Services',room:'Spa Services',gallery:'Spa Gallery',specialty:'Facials · wellness · relaxation',promo:'Relax, reset and make time for your wellness.',bio:'Explore spa services and availability.'},
    spraytan:{label:'Spray Tan Artist',booking:'Book Spray Tan',services:'Spray tan · glow services',social:'See My Work',dock:'Services',room:'Spray Tan Services',gallery:'Results',specialty:'Spray tan · glow services',promo:'Custom glow services for your tone and occasion.',bio:'Explore services, results and availability.'},
    pmu:{label:'Permanent Makeup Artist',booking:'Book PMU Consultation',services:'PMU · brows · lips',social:'See My Work',dock:'Services',room:'Permanent Makeup Services',gallery:'PMU Portfolio',specialty:'Permanent makeup · brows · lips',promo:'Permanent makeup services with consultation-first care.',bio:'Explore services, healed results and availability.'},
    tattoo:{label:'Tattoo Artist',booking:'Request Tattoo Appointment',services:'Flash · custom · fine line · color',social:'See My Tattoo Work',dock:'Services',room:'Tattoo Services',gallery:'Tattoo Portfolio',specialty:'Flash · custom · fine line · color',promo:'Custom work, flash and thoughtful tattoo design.',bio:'Explore tattoo work, services and availability.'},
    piercing:{label:'Piercer',booking:'Book Piercing',services:'Piercing · jewelry',social:'See My Work',dock:'Services',room:'Piercing Services',gallery:'Piercing Portfolio',specialty:'Piercing · jewelry',promo:'Professional piercing services and jewelry options.',bio:'Explore services, work and availability.'},
    toothgem:{label:'Tooth Gem Artist',booking:'Book Tooth Gem Appointment',services:'Tooth gems · smile styling',social:'See My Work',dock:'Services',room:'Tooth Gem Services',gallery:'Smile Portfolio',specialty:'Tooth gems · smile styling',promo:'Smile styling with tooth gem services.',bio:'Explore options, work and availability.'},
    cosmetics:{label:'Beauty / Cosmetics',booking:'Book Consultation',services:'Products · beauty · consultations',social:'See What’s New',dock:'Services',room:'Beauty Services',gallery:'Beauty Portfolio',specialty:'Beauty · products · consultations',promo:'Beauty services and product guidance for your routine.',bio:'Explore services, products and consultations.'},
    salon:{label:'Salon / Multi-Service Studio',booking:'Book Appointment',services:'Multi-service beauty studio',social:'Explore Our Work',dock:'Services',room:'Studio Services',gallery:'Studio Portfolio',specialty:'Hair · beauty · wellness services',promo:'One Studio, multiple services.',bio:'Explore services, professionals and availability.'},
    other:{label:'Studio Professional',booking:'Book Appointment',services:'Professional services',social:'See My Work',dock:'Services',room:'Studio Services',gallery:'Portfolio',specialty:'Professional services · appointments',promo:'Explore services, recent work and availability.',bio:'Browse services, work and availability, then book or get in touch.'}
  };
  ...
  function businessIcon(type,size=20){
    ...
    return open+(paths[iconType]||paths.barber)+'</svg>';
  }
