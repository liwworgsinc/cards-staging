/* Extra LIW Cards social/app icons. GitHub mark from GitHub Primer Octicons. */
(function () {
  if (!Array.isArray(window.DOTCO_SOCIALS)) return;
  if (window.DOTCO_SOCIALS.some(item => item && item.key === 'github')) return;

  window.DOTCO_SOCIALS.push({
    key: 'github',
    label: 'GitHub',
    viewBox: '0 0 24 24',
