...
(function(){
  ...
  const TYPES=new Set(['barber','hair','braider','loctician','wig','nails','lashes','brows','makeup','esthetician','wax','massage','spa','spraytan','pmu','tattoo','piercing','toothgem','cosmetics','salon','other']);
