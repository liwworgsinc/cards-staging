...
(function(){
  ...
  function injectStyles(){
    ...
    style.textContent=`
      ...
      @media(max-width:620px){.realtor-public-shell{border-radius:0;box-shadow:none}.realtor-public-hero{min-height:320px;border-radius:0}.realtor-public-top{left:14px;right:14px;top:max(14px,env(safe-area-inset-top,0px))}.realtor-public-brand{max-width:calc(100% - 124px);gap:8px}.realtor-public-brand img{flex-basis:44px;width:44px;height:44px}.realtor-public-top-actions{gap:5px}.realtor-public-icon{width:34px;height:34px}.realtor-public-agent{grid-template-columns:148px minmax(0,1fr);gap:14px;padding:18px}.realtor-public-avatar{width:148px;height:148px;border-width:5px}.realtor-public-agent h1{font-size:clamp(1.35rem,7vw,2rem)}.realtor-public-body{padding:16px}.realtor-public-actions{gap:7px}.realtor-public-action{min-height:62px}.realtor-public-nav{grid-template-columns:repeat(2,1fr)}.realtor-section,.realtor-feature-card,.realtor-card-grid{display:grid!important;visibility:visible!important;opacity:1!important}.realtor-feature-photo{height:205px}.realtor-card-grid{grid-template-columns:1fr}.realtor-gallery{grid-template-columns:1fr 1fr}.realtor-gallery img,.realtor-gallery img:first-child{height:150px;grid-row:auto}.realtor-lead-form .row{grid-template-columns:1fr}}
