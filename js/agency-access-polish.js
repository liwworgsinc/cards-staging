(function(){
  ...
  function loadCardsEnhancement(){
    /* White Work Center owns Cards section state. Keep the premium tile styling,
       but do not load the legacy Cards MutationObserver/collapse controller. */
    addCss('agency-cards-polish','css/agency-cards-polish.css?v=20260830-freeze-fix-1');
  }
