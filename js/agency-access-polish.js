(function(){
  ...
  function loadApprovalEnhancement(){
    if(!document.querySelector('link[data-agency-approval-workflow]')){
      const link=document.createElement('link');link.rel='stylesheet';link.href='css/agency-approval-workflow-staging.css?v=20260821-6';link.dataset.agencyApprovalWorkflow='true';document.head.appendChild(link);
    }
