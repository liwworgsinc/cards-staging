...
(function(){
  ...
  function injectStyles(){
    ...
    style.textContent=`
      ...
      body.liw-social-clean-staging .social-quick-section>.section-mini-heading{
        margin:0 0 11px!important;
      }
      body.liw-social-clean-staging .social-quick-section>.section-mini-heading>div{
        display:flex!important;
        align-items:baseline!important;
        gap:9px!important;
        flex-wrap:wrap!important;
      }
      body.liw-social-clean-staging .social-quick-section>.section-mini-heading h3{
        margin:0!important;
      ...
      body.liw-social-clean-staging .social-quick-section>.section-mini-heading h3 span{
      ...
      body.liw-social-clean-staging .social-quick-section>.section-mini-heading p{
        width:100%!important;
      ...
      body.liw-social-clean-staging #social-quick-add{
        display:grid!important;
        grid-template-columns:repeat(6,minmax(0,1fr))!important;
        gap:7px!important;
        margin:0!important;
      }
      body.liw-social-clean-staging #social-quick-add button{
        ...
        box-shadow:0 4px 12px rgba(11,20,56,.035)!important;
      ...
      body.liw-social-clean-staging #social-quick-add button:hover{
        transform:translateY(-1px)!important;
        border-color:#cfb46e!important;
        box-shadow:0 7px 16px rgba(11,20,56,.07)!important;
      }
      body.liw-social-clean-staging #social-quick-add button:focus-visible{
        outline:3px solid rgba(212,168,79,.18)!important;
      ...
      body.liw-social-clean-staging #social-quick-add button>svg{
        width:19px!important;
        height:19px!important;
        flex:0 0 19px!important;
      }
      body.liw-social-clean-staging #social-quick-add button>span:last-child{
      ...
      body.liw-social-clean-staging #social-more-trigger{
      ...
      body.liw-social-clean-staging #social-more-trigger:hover{
        background:#fff9ea!important;
        border-color:#d8c58d!important;
        transform:none!important;
      }
      body.liw-social-clean-staging #social-more-trigger small{
        color:#7c8495!important;
        font-size:.6rem!important;
      }
      body.liw-social-clean-staging #add-social{
        display:none!important;
      }
      body.liw-social-clean-staging .social-appearance-details{
        margin-top:10px!important;
      }
      body.liw-social-clean-staging #social-list:not(:empty){
        margin-top:12px!important;
      }
      body.liw-social-clean-staging .social-quick-section+.social-appearance-details~.input-help{
  ...
  function cleanQuickButtons(){
    ...
    grid.querySelectorAll('[data-quick-social]').forEach(button=>{
      ...
      let icon='';
      try{
        if(typeof window.socialIconHtml==='function')icon=window.socialIconHtml(key,{size:19});
      }catch(_){ }
      if(!icon){
