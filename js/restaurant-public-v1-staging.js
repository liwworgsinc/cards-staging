...
(function(){
  ...
  function shell(cardData){
    ...
    const actionReserve=reserve?'<a class="restaurant-public-action" data-rest-reserve href="'+esc(reserve)+'" target="_blank" rel="noopener"><i data-lucide="calendar-check-2" size="20"></i><span>Reserve</span></a>':'<button class="restaurant-public-action" data-rest-reserve type="button" disabled><i data-lucide="calendar-check-2" size="20"></i><span>Reserve</span></button>';
