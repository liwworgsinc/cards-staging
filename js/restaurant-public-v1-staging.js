...
(function(){
  ...
  function injectStyles(){
    ...
    style.textContent=`
      ...
      .restaurant-see-menu{align-self:end;color:#8a5c12;text-decoration:none;font-family:Georgia,'Times New Roman',serif;font-size:.82rem;font-weight:800;border-bottom:1px solid currentColor;padding-bottom:3px}
