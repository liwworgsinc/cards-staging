...
(function(){
  ...
  function injectStyles(){
    ...
    style.textContent=`
      ...
      @media(max-width:620px){#restaurant-public-shell{border-radius:0;box-shadow:none}.restaurant-public-hero{min-height:410px}.restaurant-public-top{top:max(10px,env(safe-area-inset-top,0px));left:10px;right:10px}.restaurant-public-corner-brand{max-width:46%;padding:7px 9px;font-size:.66rem}.restaurant-public-icon{width:35px;height:35px}.restaurant-public-identity{left:18px;right:18px;bottom:78px}.restaurant-public-body{padding:0 14px 18px}.restaurant-public-actions{grid-template-columns:repeat(4,minmax(0,1fr));margin-top:-40px;border-radius:26px;padding:8px 4px}.restaurant-public-action{min-height:82px;font-size:.69rem}.restaurant-public-action svg{width:19px;height:19px;padding:9px}.restaurant-menu-grid{grid-auto-columns:minmax(84%,310px);gap:12px}.restaurant-menu-photo{height:170px}.restaurant-menu-copy{padding:13px}.restaurant-feature-card{min-height:285px}.restaurant-feature-photo{height:auto}.restaurant-feature-copy{min-height:285px;width:63%;padding:68px 16px 18px}.restaurant-info-drawer{grid-template-columns:repeat(2,1fr)}.restaurant-signature-head{grid-template-columns:1fr auto}.restaurant-signature-title{font-size:1.92rem;max-width:68%}.restaurant-see-menu{font-size:.7rem;white-space:nowrap}.restaurant-deal-card{grid-template-columns:1fr auto;padding:16px}.restaurant-deal-copy h3{font-size:1.15rem}.restaurant-deal-price{font-size:1.15rem}}
    `;
