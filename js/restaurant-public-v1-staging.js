...
(function(){
  ...
  function injectStyles(){
    ...
    style.textContent=`
      ...
      .restaurant-public-top{position:absolute;z-index:3;left:14px;right:14px;top:14px;display:flex;align-items:center;justify-content:space-between;gap:10px;padding:8px 9px;border:1px solid rgba(255,255,255,.22);border-radius:20px;background:linear-gradient(135deg,rgba(19,17,13,.56),rgba(19,17,13,.24));backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);box-shadow:0 12px 30px rgba(0,0,0,.16)}.restaurant-public-brand-lockup{min-width:0;display:flex;align-items:center;gap:9px}.restaurant-public-brand-mark{width:38px;height:38px;flex:0 0 38px;border-radius:50%;overflow:hidden;display:grid;place-items:center;background:rgba(255,255,255,.14);border:1px solid rgba(255,255,255,.32);color:#fff}.restaurant-public-brand-mark img{width:100%;height:100%;object-fit:cover}.restaurant-public-brand-copy{min-width:0;display:grid;gap:1px}.restaurant-public-brand{max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#fff;font-family:Georgia,'Times New Roman',serif;font-size:.78rem;font-weight:800;letter-spacing:.01em;text-transform:none;line-height:1.1}.restaurant-public-brand-sub{color:rgba(255,255,255,.7);font-size:.49rem;font-weight:900;letter-spacing:.12em;text-transform:uppercase}.restaurant-public-top-actions{display:flex;gap:6px;flex:0 0 auto}.restaurant-public-icon{width:36px;height:36px;border:1px solid rgba(255,255,255,.18);border-radius:50%;background:rgba(255,255,255,.92);color:#17130f;display:grid;place-items:center;cursor:pointer;box-shadow:0 5px 16px rgba(0,0,0,.12)}.restaurant-public-icon[data-rest-wallet]{background:linear-gradient(135deg,var(--rest-accent),#f7d978)}
      ...
      @media(max-width:620px){#restaurant-public-shell{border-radius:0;box-shadow:none}.restaurant-public-hero{min-height:410px}.restaurant-public-top{top:max(10px,env(safe-area-inset-top,0px));left:10px;right:10px;padding:7px}.restaurant-public-brand-mark{width:34px;height:34px;flex-basis:34px}.restaurant-public-icon{width:34px;height:34px}.restaurant-public-identity{left:18px;right:18px;bottom:78px}.restaurant-public-body{padding:0 14px 18px}.restaurant-public-actions{grid-template-columns:repeat(4,minmax(0,1fr));margin-top:-40px;border-radius:26px;padding:8px 4px}.restaurant-public-action{min-height:82px;font-size:.69rem}.restaurant-public-action svg{width:19px;height:19px;padding:9px}.restaurant-menu-grid{grid-auto-columns:minmax(82%,300px)}.restaurant-feature-card{min-height:285px}.restaurant-feature-photo{height:auto}.restaurant-feature-copy{min-height:285px;width:63%;padding:68px 16px 18px}.restaurant-info-drawer{grid-template-columns:repeat(2,1fr)}.restaurant-signature-head{grid-template-columns:1fr auto}.restaurant-signature-title{font-size:1.92rem;max-width:68%}.restaurant-see-menu{font-size:.7rem;white-space:nowrap}}
    `;
