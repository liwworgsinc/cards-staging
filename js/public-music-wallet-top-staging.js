...
(function loadArtistPerformerModulesV2(){
  ...
  const script=document.createElement('script');script.src='js/public-artist-performer-modules-v2-staging.js?v=20260907-more-role-label-1';script.defer=true;script.dataset.liwPublicArtistPerformerModulesV2='true';document.body.appendChild(script);
})();
