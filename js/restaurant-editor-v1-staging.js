...
(function(){
  ...
  let settings={cuisine:'',service_style:'',tagline:'',price_note:'',order_url:'',reservation_url:'',delivery_note:'',featured_item_name:'',video_cover_url:'',chef_name:'',chef_title:'',chef_note:'',name_font:'Georgia',deal_enabled:'',deal_title:'',deal_price:'',deal_note:'',deal_url:''};
  ...
  function ensureUi(){
    ...
    if(!q('.restaurant-control-center')){
      ...
      panel.innerHTML=`
        ...
        <div class="restaurant-tool-tabs"><button type="button" class="active" data-restaurant-tab="profile">Restaurant</button><button type="button" data-restaurant-tab="menu">Menu</button><button type="button" data-restaurant-tab="deals">Deals</button><button type="button" data-restaurant-tab="actions">Order & Reserve</button></div>
