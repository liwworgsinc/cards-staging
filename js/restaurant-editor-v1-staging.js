...
(function(){
  ...
  function injectStyles(){
    ...
    style.textContent=`
      ...
      .restaurant-phone-actions{position:relative;z-index:5;margin:-39px 0 3px;padding:6px 4px;grid-template-columns:repeat(4,minmax(0,1fr))!important;gap:0!important;border:1px solid rgba(133,94,36,.12);border-radius:22px;background:rgba(255,252,246,.97);box-shadow:0 12px 26px rgba(38,24,9,.16)}
